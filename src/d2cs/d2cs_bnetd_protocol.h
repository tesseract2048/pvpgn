...
#define D2CS_BNETD_JOINGAMESIGNAL			0x13
typedef struct
{
	t_d2cs_bnetd_header	h;
	/* accname */
	...
	/* gamename@realmname */
	/* gamepass */
} t_d2cs_bnetd_joingamesignal;

#define D2CS_BNETD_CHAROPTSIGNAL			0x14
typedef struct
{
	t_d2cs_bnetd_header	h;
	bn_int		opt_type;
	...
	/* charname */
	/* ipaddr */
} t_d2cs_bnetd_charoptsignal;

#define BNETD_D2CS_OPERATE			0x15
typedef struct
{
	t_d2cs_bnetd_header	h;
	bn_byte		opt;
} t_bnetd_d2cs_operate;
