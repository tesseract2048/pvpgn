...
extern int d2cs_conn_set_vip_expire(t_connection * c, unsigned int vip_expire);
extern unsigned int d2cs_conn_get_vip_expire(t_connection * c);

static unsigned int vip_realm;
#endif
