...
static int conf_set_trans_gs(const char* valstr);
static int conf_setdef_trans_gs(void);

static int conf_set_gs_cnc(const char* valstr);
static int conf_setdef_gs_cnc(void);

static int conf_set_gs_ctc(const char* valstr);
static int conf_setdef_gs_ctc(void);
...
static t_conf_entry prefs_conf_table[]={
    ...
    { "trans_gs",          conf_set_trans_gs,          NULL,    conf_setdef_charlist_sort},
    { "gs_cnc",    conf_set_gs_cnc,    NULL,    conf_setdef_gs_cnc},
    { "gs_ctc",    	conf_set_gs_ctc,    	 NULL,    conf_setdef_gs_ctc},
    { NULL,                     NULL,                            NULL,    NULL }
};
...
extern unsigned int prefs_get_trans_gs(void)
{
	return prefs_conf.trans_gs;
}

static int conf_set_trans_gs(const char* valstr)
{
	return conf_set_int(&prefs_conf.trans_gs,valstr,0);
}

static int conf_setdef_trans_gs(void)
{
	return conf_set_int(&prefs_conf.trans_gs,NULL,0);
}


extern char const * prefs_get_gs_cnc(void)
{
	return prefs_conf.gs_cnc;
}

static int conf_set_gs_cnc(const char* valstr)
{
	return conf_set_str(&prefs_conf.gs_cnc,valstr,NULL);
}

static int conf_setdef_gs_cnc(void)
{
	return conf_set_str(&prefs_conf.gs_cnc,NULL,"");
}

extern char const * prefs_get_gs_ctc(void)
{
	return prefs_conf.gs_ctc;
}

static int conf_set_gs_ctc(const char* valstr)
{
	return conf_set_str(&prefs_conf.gs_ctc,valstr,NULL);
}

static int conf_setdef_gs_ctc(void)
{
	return conf_set_str(&prefs_conf.gs_ctc,NULL,"");
}
