...
static struct {
	...
	unsigned int vip_experience;
	char const * mirror_ip;
...
static int conf_set_eqn_hashstr(const char *valstr);
static const char *conf_get_eqn_hashstr(void);
static int conf_setdef_eqn_hashstr(void);

static int conf_set_vip_experience(const char *valstr);
static const char *conf_get_vip_experience(void);
static int conf_setdef_vip_experience(void);

static int conf_set_mirror_ip(const char *valstr);
static const char *conf_get_mirror_ip(void);
static int conf_setdef_mirror_ip(void);
...
static t_conf_entry conf_table[] =
  {
    ...
    { "eqn_hashstr",			conf_set_eqn_hashstr,		conf_get_eqn_hashstr,	conf_setdef_eqn_hashstr},
    ...
    { "vip_experience",		conf_set_vip_experience,              conf_get_vip_experience, conf_setdef_vip_experience},
    { "mirror_ip",		conf_set_mirror_ip,              conf_get_mirror_ip, conf_setdef_mirror_ip},
...
static int conf_set_eqn_hashstr(const char *valstr)
{
    return conf_set_str(&prefs_runtime_config.eqn_hashstr,valstr,NULL);
}
...
static int conf_setdef_eqn_hashstr(void)
{
    return conf_set_str(&prefs_runtime_config.eqn_hashstr,NULL,"BINARIEWITHDAWN");
}
...
extern unsigned int prefs_get_eqn_hashstr(void)
{
    return prefs_runtime_config.eqn_hashstr;
}
...
static char const * conf_get_eqn_hashstr(void)
{
     return prefs_runtime_config.eqn_hashstr;
}
...
static int conf_set_vip_experience(const char *valstr)
{
	return conf_set_int(&prefs_runtime_config.vip_experience,valstr,0);
}

static int conf_setdef_vip_experience(void)
{
	return conf_set_int(&prefs_runtime_config.vip_experience,NULL,0);
}

static const char* conf_get_vip_experience(void)
{
	return conf_get_int(prefs_runtime_config.vip_experience);
}
...
static int conf_set_mirror_ip(const char *valstr)
{
    return conf_set_str(&prefs_runtime_config.mirror_ip,valstr,NULL);
}

extern char const * prefs_get_mirror_ip(void)
{
     return prefs_runtime_config.mirror_ip;
}

static char const * conf_get_mirror_ip(void)
{
     return prefs_runtime_config.mirror_ip;
}
...
static int conf_setdef_mirror_ip(void)
{
    return conf_set_str(&prefs_runtime_config.mirror_ip,NULL,0);
}