...
extern t_account * accountlist_create_account2(const char *username, const char *passhash1, char const * cip);
extern t_account * accountlist_create_account3(const char *username, const char *passhash1, char const * email);
extern t_account * accountlist_create_account4(const char *username, const char *passhash1, char const * email, char const * cip);
