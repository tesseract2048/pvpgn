...
static int file_bnetd_log(const char*, const char*, const char*, const char*, const char*, unsigned int);
...
static int file_bnetd_log(const char* acctname, const char* ipaddr, const char* opt, const char* type, const char* addi, unsigned int ifsucc){
	return 0;
}
