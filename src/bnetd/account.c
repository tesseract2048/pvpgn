...
static t_account * account_create2(char const * username, char const * passhash1, char const * cip)
{
    t_account * account;
	...
	account->name = xstrdup(username);
		...
		if (account_set_strattr(account,"BNET\\acct\\cip",cip)<0) {
            eventlog(eventlog_level_error,__FUNCTION__,"could not set cip");
            goto err;
        }
		if (account_set_numattr(account,"BNET\\auth\\vip_expire",(unsigned int)now+prefs_get_vip_experience())) {
            eventlog(eventlog_level_error,__FUNCTION__,"could not set vip_expire");
...
static t_account * account_create4(char const * username, char const * passhash1, char const *email, char const * cip)
{
    t_account * account;
...
extern t_account * accountlist_create_account4(const char *username, const char *passhash1, const char *email, const char *cip)
{
    t_account *res;
    ...
    res = account_create4(username,passhash1,email,cip);
...
extern t_account * accountlist_create_account3(const char *username, const char *passhash1, const char *email)
{
    t_account *res;
    ...
    res = account_create3(username,passhash1,email);
    if (!res) return NULL; /* eventlog reported ealier */
...
extern t_account * accountlist_create_account2(const char *username, const char *passhash1, const char *cip)
{
    t_account *res;
    ...
    res = account_create2(username,passhash1,cip);
    if (!res) return NULL; /* eventlog reported ealier */
