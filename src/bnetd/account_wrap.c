...
extern int account_get_auth_vip_expire(t_account * account)
{
    return account_get_numattr(account,"BNET\\auth\\vip_expire");
}

extern int account_set_auth_vip_expire(t_account * account, unsigned int val)
{
    return account_set_numattr(account,"BNET\\auth\\vip_expire", val);
}
