...
#define SERVER_LOGINREPLY_W3_MESSAGE_LOCKED 0x0000000A /* Accoutn does not exist */
#define SERVER_LOGINREPLY_W3_MESSAGE_DENIED 0x00000091
/******************************************************/
...
Packet #13
0x0000   FF 54 1C 00 00 00 00 00-3A D5 B9 B1 2B D9 B5 D9   žT......:Õ¹?Ùµ?
0x0010   87 3B 2B 3D 28 57 C0 2E-02 93 5F 8B               ?+=(W?.??
*/
...
#define SERVER_LOGINREPLY2_MESSAGE_LOCKED 0x0000000A /* Bad password */
#define SERVER_LOGINREPLY2_MESSAGE_DENIED 0x00000091 /* Unique acc service */
/******************************************************/
...
#define SERVER_LOGINREPLY1_MESSAGE_DENIED  0x00000091
/******************************************************/
...
/*Paquet #267
0x0000   FF 75 0A 00 00 00 42 54-54 04                     žu....BTT.
*/
/*
...
/*3756: 
Paquet #266
0x0000   FF 71 0A 00 05 00 00 00-00 00                     žq........
...
/*
Paquet #52
0x0000   FF 7D 10 01 01 00 00 00-13 4D 79 73 74 69 2E 53   ž}.......Mysti.S
...
/*
Paquet #51
0x0000   FF 7D 08 00 01 00 00 00-                          ž}......
*/
...
#define CLIENT_ANTIBOT_GREET 0xd291
typedef struct
{
    t_bnet_header h;
    bn_int        result_s;
} PACKED_ATTR() t_client_antibot_greet;

#define SERVER_ANTIBOT_GREET 0xd291
typedef struct
{
    t_bnet_header h;
    bn_int        key_s;
    bn_int        word_s;
} PACKED_ATTR() t_server_antibot_greet;

#define SERVER_MSGBOX		0x99ff
typedef struct
{
	t_bnet_header	h;
	/* string  - text */
} PACKED_ATTR() t_server_msgbox;

#define S2S_OPERATE 0x8888
typedef struct
{	
    t_bnet_header h;
	bn_int        key;
	bn_short      operate;
	bn_int        seqno;
} PACKED_ATTR() t_s2s_operate;


#define S2S_OPERATE_REPLY 0x8888
typedef struct
{	
    t_bnet_header h;
	bn_int        seqno;
	bn_short      result;
} PACKED_ATTR() t_s2s_operate_reply;

#define S2S_OPERATE_CREATEACCT 0x0001
#define S2S_OPERATE_SETPASSWD 0x0002
#define S2S_OPERATE_SETEMAIL 0x0003
#define S2S_OPERATE_LOCKACCT 0x0004
#define S2S_OPERATE_UNLOCKACCT 0x0005
#define S2S_OPERATE_EXTENDVIP 0x0006
#define S2S_OPERATE_CHECKMAIL 0x0007

#define S2S_OPERATE_REPLY_INVALID 0x0000
#define S2S_OPERATE_REPLY_SUCC 0x0001
#define S2S_OPERATE_REPLY_EXIST 0x0002
#define S2S_OPERATE_REPLY_NOTFOUND 0x0003
#define S2S_OPERATE_REPLY_INCORRECT 0x0004


#define S2S_STAT_REQUEST 0x8889
typedef struct
{	
    t_bnet_header h;
} PACKED_ATTR() t_s2s_stat_request;

#define S2S_STAT_REPLY 0x8889
typedef struct
{	
    t_bnet_header h;
	bn_int		  players;
	...
	bn_int      realm_num;
	/* realm stat info */
} PACKED_ATTR() t_s2s_stat_reply;

typedef struct
{
	bn_int		 realm_players;
	bn_int	     realm_games;
	/* realm name */
} t_realm_stat_info;


#define S2S_SYS_ANN 0x8829
typedef struct
{	
    t_bnet_header h;
	/* text */
} PACKED_ATTR() t_s2s_sys_ann;
