...
typedef struct
{
	...
	t_d2cs_d2gs_setconffile			d2cs_d2gs_setconffile;
		...
		t_d2cs_bnetd_joingamesignal		d2cs_bnetd_joingamesignal;
		t_d2cs_bnetd_charoptsignal		d2cs_bnetd_charoptsignal;
		t_bnetd_d2cs_operate			bnetd_d2cs_operate;
	...
	t_client_antibot_greet          client_antibot_greet;
	t_server_antibot_greet          server_antibot_greet;

	
	t_s2s_operate		          s2s_operate;
	t_s2s_operate_reply		          s2s_operate_reply;
	t_server_msgbox		          server_msgbox;

	t_s2s_stat_request			s2s_stat_request;
	t_s2s_stat_reply            s2s_stat_reply;
	t_s2s_sys_ann				s2s_sys_ann;
	} u;
} t_packet;
