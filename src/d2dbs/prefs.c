...
static int conf_set_datahash_org(const char* valstr);
static int conf_setdef_datahash_org(void);
...
static t_conf_entry prefs_conf_table[]={
    ...
    { "datahash_org",           conf_set_datahash_org,			 NULL,    conf_setdef_datahash_org },
    { NULL,                     NULL,                            NULL,    NULL }
};
...
static int conf_setdef_charsave_bak_dir(const char * valstr)
{
...
static int conf_set_datahash_org(const char * valstr)
{
	return conf_set_str(&prefs_conf.datahash_org,valstr,NULL);
}

static int conf_setdef_datahash_org(void)
{
	return conf_set_str(&prefs_conf.datahash_org,NULL,"");
}
...
extern char const * prefs_get_datahash_org(void)
{
	return prefs_conf.datahash_org;
}